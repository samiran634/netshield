...
Evaluate it based on the following three specific issues:
  ...
  **Rating System (on a scale of 1 to 5 for each issue):**
  - **1** = No issue present
  - **2** = Mild concern (borderline inappropriate or misleading)
  - **3** = Moderate concern (some clear problematic language or misinformation)
  - **4** = High concern (strongly offensive or false)
  - **5** = Extreme concern (highly offensive, harmful, or severely misleading)
      ...
      <div className="flex-1">
        <div className="flex items-center space-x-2">
          ...
          {healthRating && (
            ...
            >
              ❤️
              <span className="absolute hidden group-hover:block bg-black text-white text-xs p-1 rounded -top-8 left-0 z-10">
